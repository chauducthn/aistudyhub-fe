...
import { listAdminDocuments } from '../api/adminApi'
    ...
    <DashboardShell type="admin">
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <h1 className="text-3xl font-extrabold text-[#0b1c30] sm:text-4xl">All Documents</h1>
            <p className="mt-2 text-base text-[#464555]">
              Full-text search across every user&apos;s documents.
            </p>
          </div>
